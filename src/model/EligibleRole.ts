 ...
 */
export const setRoleScheduleAccount = (schedule: RoleSchedule, account: AccountInfo) => {
 ...
 */
export const getRoleScheduleAccount = (schedule: RoleSchedule) => commonRoleScheduleAccountMap[schedule.id]
